    ...
    <div className="panel2">
      <IntersectViewport className="topic right">
        ...
        <div className="content">
          ...
          avant-garde custom software and blockchain solutions. We aim to
          achieve the highest standard of building software solutions across the
          globe through user-focused efforts. Empower SMBs and enterprises
          through innovative technologies, and digital products- to drive a new
          era of development, ingenuity, and possibilities. We are moving
          steadily towards being a world-leading custom software and blockchain
          solutions company because we believe that the future belongs to those
